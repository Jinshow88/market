...
@Getter
@Setter
public class UpdateImageResponseDto extends ResponseDto{

    private UpdateImageResponseDto(){
        super(SUCCESS_CODE, SUCCESS_MESSAGE);
    }

    public static ResponseEntity<UpdateImageResponseDto> success(){
        UpdateImageResponseDto result = new UpdateImageResponseDto();
