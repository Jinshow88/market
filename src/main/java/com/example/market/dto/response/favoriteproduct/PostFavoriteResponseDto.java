...
@Getter
@Setter
public class PostFavoriteResponseDto extends ResponseDto{

    private PostFavoriteResponseDto(){
        super(SUCCESS_CODE, SUCCESS_MESSAGE);
    }
    
    public static ResponseEntity<PostFavoriteResponseDto> success(){
        PostFavoriteResponseDto result = new PostFavoriteResponseDto();
