...
@Getter
@Setter
public class DeleteRevicwResponseDto extends ResponseDto{
    
    private DeleteRevicwResponseDto(){
        super(SUCCESS_CODE, SUCCESS_MESSAGE);
    }

    public static ResponseEntity<DeleteRevicwResponseDto> success(){
        DeleteRevicwResponseDto result = new DeleteRevicwResponseDto();
