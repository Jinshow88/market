...
@Getter
@Setter
public class PostImageResponseDto extends ResponseDto{

    private PostImageResponseDto(){
        super(SUCCESS_CODE, SUCCESS_MESSAGE);
    }

    public static ResponseEntity<PostImageResponseDto> success(){
        PostImageResponseDto result = new PostImageResponseDto();
